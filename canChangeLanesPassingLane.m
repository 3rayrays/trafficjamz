...
% if both lanes are good to switch to, then switch to left lane
if left && right
    output = lane+1;
% if the left lane is good to switch to, do that
elseif left  
    output = lane+1;
% if the right lane is good to switch to, AND you are in the leftmost lane
elseif right && lane==numLanes
    output = lane-1;
